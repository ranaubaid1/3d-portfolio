...
function init3DEngine() {
    ...
    const cyanLight = new THREE.PointLight(0x10b981, 7, 12); // Emerald Jade accent
    scene.add(cyanLight);

    const magentaLight = new THREE.PointLight(0x00cc66, 7, 12); // Neon Green primary
    scene.add(magentaLight);

    // Glowing Cyber Grid Helper
    const gridHelper = new THREE.GridHelper(30, 30, 0x00cc66, 0x1e293b);
